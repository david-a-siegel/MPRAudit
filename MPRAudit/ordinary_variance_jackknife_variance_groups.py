...
def ordinary_variance_jackknife_variance_groups(list_of_values_0,list_of_values_1):
    ...
    for i in range(len(list_of_values_0)):
        ...
        x_i.append((len(list_of_values_i)*np.var(list_of_values_i)+len(list_of_values_1)*np.var(list_of_values_1))/(len(list_of_values_i)+len(list_of_values_1)))
    for i in range(len(list_of_values_1)):
        list_of_values_i = np.append(list_of_values_1[:i],list_of_values_1[i+1:])
        x_i.append((len(list_of_values_i)*np.var(list_of_values_i)+len(list_of_values_0)*np.var(list_of_values_0))/(len(list_of_values_i)+len(list_of_values_0)))
