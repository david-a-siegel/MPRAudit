...
def main():
    ...
    namestring = 'simulation1_'+str(namenumber)+'.txt'
    text_file = open(namestring,"w")
    text_file.write('Num_clones')
    text_file.write(',')
    text_file.write('Fig2A_mean_jackknife') #Q2
    text_file.write(',')
    text_file.write('Fig2A_var_RD')
    text_file.write(',')
    text_file.write('Fig2A_var_jackknife')
    text_file.write(',')
    text_file.write('Fig2A_var_var_RD')
    text_file.write(',')
    text_file.write('Fig2A_b2_mean')
    text_file.write(',')
    text_file.write('Fig2A_b2_var')
    text_file.write(',')
    text_file.write('Fig3D_a1') #Q5
    text_file.write(',')
    text_file.write('Fig3D_b1')
    text_file.write(',')
    text_file.write('Fig3D_da1')
    text_file.write(',')
    text_file.write('Fig3D_db1')
    text_file.write(',')
    text_file.write('Fig3D_h21')
    text_file.write(',')
    text_file.write('Fig3D_dh21')
    text_file.write(',')
    text_file.write('Fig3D_a2')
    text_file.write(',')
    text_file.write('Fig3D_b2')
    text_file.write(',')
    text_file.write('Fig3D_da2')
    text_file.write(',')
    text_file.write('Fig3D_db2')
    text_file.write(',')
    text_file.write('Fig3D_h22')
    text_file.write(',')
    text_file.write('Fig3D_dh22')
    text_file.write(',')
    text_file.write('Fig3A_a') #Q4
    text_file.write(',')
    text_file.write('Fig3A_b')
    text_file.write(',')
    text_file.write('Fig3A_da')
    text_file.write(',')
    text_file.write('Fig3A_db')
    text_file.write(',')
    text_file.write('Fig3A_h2')
    text_file.write(',')
    text_file.write('Fig3A_dh2')
    text_file.write(',')
    text_file.write('Fig4A_a')
    text_file.write(',')
    text_file.write('Fig4A_b')
    text_file.write(',')
    text_file.write('Fig4A_da')
    text_file.write(',')
    text_file.write('Fig4A_db')
    text_file.write(',')
    text_file.write('Fig4A_h2')
    text_file.write(',')
    text_file.write('Fig4A_dh2')
    text_file.write('\n')
    ...
    for num_clones in range(2,21):
        ...
        for cluster_repeats in range(2):
            ...
            for A_value in A_list:
                RNA_sampled, DNA_sampled, sum_RNA, sum_DNA = return_counts(num_clones=num_clones,dna_per_clone=20,A=A_value,s=0.1,sigma_mu_ratio=30., K=10)  #A is the ratio, K is counts
            ...
            #Fig 3D. Do sequences with TATACAG have more b^2 than randomly generated sequences?
            ...
            #Fig 3A. If we only know about TATACAG, can we infer some residual b2?
            ...
            #Fig 4A. Do random edits to TATACAG account for some of the variance?
